...
with open('Telco_churn\\DT\\fe_X_train.pickle', 'wb') as f:
    pickle.dump(fe_X_train, f)
with open('Telco_churn\\DT\\fe_X_test.pickle', 'wb') as f:
    pickle.dump(fe_X_test, f)
with open('Telco_churn\\DT\\y_train.pickle', 'wb') as f:
    pickle.dump(y_train, f)
with open('Telco_churn\\DT\\y_test.pickle', 'wb') as f:
    pickle.dump(y_test, f)
with open('Telco_churn\\DT\\fe_columns.pickle', 'wb') as f:
